...
public class EditActivity extends AppCompatActivity {
    ...
    private void updateView() {
        ...
        if(friends.size() >0){
            ...
            for(Friends friend : friends){
                ...
                namesAndPrices[i][0].setText(friend.getName());
                namesAndPrices[i][1].setText("" + friend.getEmail());


                namesAndPrices[i][0].setId(friend.getId());
                namesAndPrices[i][1].setId( friend.getId() + 1);
                ...
                grid.addView(namesAndPrices[i][0], (int) (width * .27),
                        ViewGroup.LayoutParams.WRAP_CONTENT);
                grid.addView(namesAndPrices[i][1], (int) (width * .20),
                        ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private class ButtonHandler implements View.OnClickListener{
        ...
        public void onClick(View v) {
            int id = v.getId();
            EditText NameET = findViewById(id);
            EditText eMailET = findViewById(id + 1);
            ...
            try{
                dbManager.updateById(id, Name, Email);
